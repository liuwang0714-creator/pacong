...
location={
    "ancestorOrigins": {},
    "href": "https://y.qq.com/n/ryqq_v2/search?w=%E5%91%A8%E6%9D%B0%E4%BC%A6&t=song&remoteplace=txt.yqq.center",
    ...
    "search": "?w=%E5%91%A8%E6%9D%B0%E4%BC%A6&t=song&remoteplace=txt.yqq.center",
    "hash": ""
}
        ...
        data=JSON.stringify({
            "comm":
                {"cv":4747474,
                    ...
                    "needNewCode":1,
                    "uin":1989811470,
                    "g_tk_new_20200303":29073143,
                    "g_tk":29073143},
            "req_1":{"method":"DoSearchForQQMusicDesktop",
                "module":"music.search.SearchCgiService",
                "param":{"remoteplace":"txt.yqq.center",
                    "searchid":"69040169106063737",
                    "search_type":0,
                    "query":name,
...
app.post('/encrypt', (req, res) => {
    try {
        ...
        const result = se(uint8);

        // 返回base64字符串给Python
        const base64Str =JSON.stringify(result);
        res.send(base64Str);
...
// 启动服务
app.listen(8676, () => {
    console.log('✅ 服务已启动: http://127.0.0.1:8676');
});
